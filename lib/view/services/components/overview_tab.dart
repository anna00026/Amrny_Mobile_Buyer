...
import 'package:amrny/view/services/components/desc_from_html.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        AutoSizeText(
          '${lnProvider.getString("Benefits of the premium package")}:',
          maxLines: 1,
          style: TextStyle(
        ...
        for (int i = 0;
          ...
          ServiceHelper().checkListCommon(
              context, provider.serviceAllDetails.serviceBenifits[i].benifits),
